...
static const char *keywords[] = {
	...
	"so plus",     /* TT_SUMOF */
	"so minus",    /* TT_DIFFOF */
	"so times",    /* TT_PRODUKTOF */
	"so divide",   /* TT_QUOSHUNTOF */
	"so mod",      /* TT_MODOF */
	"much big",    /* TT_BIGGROF */
	"much small",  /* TT_SMALLROF */
	"BOTH OF",     /* TT_BOTHOF */
	...
	"ALL OF",      /* TT_ALLOF */
	"ANY OF",      /* TT_ANYOF */
	"much saem",   /* TT_BOTHSAEM */
	"much diffrnt", /* TT_DIFFRINT */
	"MAEK",        /* TT_MAEK */
	"A",           /* TT_A */
	"IS NOW A",    /* TT_ISNOWA */
	"SMOOSH",      /* TT_SMOOSH */
	...
	"so break",    /* TT_GTFO */
	"so many",     /* TT_IMINYR */
	"such increment", /* TT_UPPIN */
	"such decrement", /* TT_NERFIN */
	"YR",          /* TT_YR */
	"TIL",         /* TT_TIL */
	"while",       /* TT_WILE */
